...
WINBASEAPI DWORD WINAPI VerFindFileA(DWORD,LPCSTR,LPCSTR,LPCSTR,LPSTR,PUINT,LPSTR,PUINT);
WINBASEAPI DWORD WINAPI VerFindFileW(DWORD,LPCWSTR,LPCWSTR,LPCWSTR,LPWSTR,PUINT,LPWSTR,PUINT);
#define                 VerFindFile WINELIB_NAME_AW(VerFindFile)
WINBASEAPI DWORD WINAPI VerLanguageNameA(DWORD,LPSTR,DWORD);
WINBASEAPI DWORD WINAPI VerLanguageNameW(DWORD,LPWSTR,DWORD);
#define                 VerLanguageName WINELIB_NAME_AW(VerLanguageName)
WINBASEAPI BOOL  WINAPI VerQueryValueA(LPCVOID,LPCSTR,LPVOID*,PUINT);
WINBASEAPI BOOL  WINAPI VerQueryValueW(LPCVOID,LPCWSTR,LPVOID*,PUINT);
#define                 VerQueryValue WINELIB_NAME_AW(VerQueryValue)
WINBASEAPI DWORD WINAPI GetFileVersionInfoSizeA(LPCSTR,LPDWORD);
WINBASEAPI DWORD WINAPI GetFileVersionInfoSizeW(LPCWSTR,LPDWORD);
#define                 GetFileVersionInfoSize WINELIB_NAME_AW(GetFileVersionInfoSize)
WINBASEAPI BOOL  WINAPI GetFileVersionInfoA(LPCSTR,DWORD,DWORD,LPVOID);
...
WINBASEAPI DWORD WINAPI GetFileVersionInfoSizeExA(DWORD,LPCSTR,LPDWORD);
WINBASEAPI DWORD WINAPI GetFileVersionInfoSizeExW(DWORD,LPCWSTR,LPDWORD);
#define                 GetFileVersionInfoSizeEx WINELIB_NAME_AW(GetFileVersionInfoSizeEx)
WINBASEAPI BOOL  WINAPI GetFileVersionInfoExA(DWORD,LPCSTR,DWORD,DWORD,LPVOID);
