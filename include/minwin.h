...
#ifndef __XGAMERUNTIME_WINDOWS_H
#define __XGAMERUNTIME_WINDOWS_H
#ifndef _INC_WINDOWS
...
extern "C++"
{
    template<typename T> const GUID &__xgameruntime_uuidof();
}

# define __CRT_UUID_DECL(type, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) \
    extern "C++" \
    { \
        template<> inline const GUID &__xgameruntime_uuidof<type>() \
        { \
        ...
        template<> inline const GUID &__xgameruntime_uuidof<type *>() \
        { \
            return __xgameruntime_uuidof<type>(); \
        } \
    }

# define __uuidof(type) __xgameruntime_uuidof<typeof(type)>()
#else
# define __CRT_UUID_DECL(type, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8)
...
# define XGAMERUNTIME_METHODENTRYBASE(return_type, qual, attribute) qual return_type attribute STDMETHODCALLTYPE
# define XGAMERUNTIME_METHODENTRY(return_type) XGAMERUNTIME_METHODENTRYBASE(return_type, static, )
# define XGAMERUNTIME_METHODENTRY_NONSTATIC(return_type) XGAMERUNTIME_METHODENTRYBASE(return_type, , )
...
# define XGAMERUNTIME_METHODENTRY(return_type) XGAMERUNTIME_METHODENTRYBASE(return_type, , __attribute__((hybrid_patchable)))
# define XGAMERUNTIME_METHODENTRY_NONSTATIC(return_type) XGAMERUNTIME_METHODENTRYBASE(return_type, , __attribute__((hybrid_patchable)))
#else
...
#endif  /* _INC_WINDOWS */
#endif  /* __XGAMERUNTIME_WINDOWS_H */
